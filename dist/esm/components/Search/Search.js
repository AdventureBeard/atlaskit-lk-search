...
var Search = /** @class */ (function (_super) {
    ...
    Search.prototype.render = function () {
        ...
        return (React.createElement(SearchInner, { className: "ak-search-inner" },
            React.createElement(SearchBox, { className: "ak-search-box" },
                React.createElement(SearchFieldBaseOuter, { className: "ak-search-field-base-outer" },
                    React.createElement(SearchFieldBaseInner, { className: "ak-search-field-base-inner" },
                        ...
                        React.createElement(SearchInput, { autoFocus: true, innerRef: this.setInputRef, onBlur: onBlur, onInput: onInput, placeholder: placeholder, spellCheck: false, type: "text", value: value, onChange: function () { }, onKeyDown: this.onInputKeyDown, className: "ak-search-input" }),

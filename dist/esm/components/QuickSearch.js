...
var QuickSearch = /** @class */ (function (_super) {
            ...
            if (event.key === 'ArrowUp') {
                ...
                if (event.shiftKey || !_this.state.selectedResultId) {
                    ...
                    if (typeof firePrivateAnalyticsEvent === 'function') {
                        ...
                        firePrivateAnalyticsEvent(QS_ANALYTICS_EV_SUBMIT, __assign(__assign({}, result.getAnalyticsData()), { method: 'returnKey', newTab: false, resultCount: _this.flatResults.length }));
                    }
    ...
    QuickSearch.prototype.UNSAFE_componentWillReceiveProps = function (nextProps) {
        ...
        if (sendAnalytics !== nextProps.firePrivateAnalyticsEvent ||
            ...
            this.setState({
                context: __assign(__assign({}, this.state.context), { sendAnalytics: nextProps.firePrivateAnalyticsEvent, linkComponent: nextProps.linkComponent }),
            });
        }
        /**
    ...
    QuickSearch.prototype.fireKeyboardControlEvent = function (selectedResultId) {
        ...
        if (firePrivateAnalyticsEvent) {
            ...
            if (result) {
                firePrivateAnalyticsEvent(QS_ANALYTICS_EV_KB_CTRLS_USED, __assign(__assign({}, result.getAnalyticsData()), { key: this.lastKeyPressed, resultCount: this.flatResults.length }));
            }
        }
        this.lastKeyPressed = '';
    };
    QuickSearch.prototype.render = function () {
        return (React.createElement(AkSearch, { isLoading: this.props.isLoading, inputControls: this.props.inputControls, onBlur: this.handleSearchBlur, onInput: this.onInput, onKeyDown: this.handleSearchKeyDown, placeholder: this.props.placeholder, value: this.state.value, autocompleteText: this.props.autocompleteText, ref: this.setSearchInputRef },

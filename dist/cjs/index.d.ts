...
export { default as ObjectResult, Props as ObjectResultProps, } from './components/Results/ObjectResult';
export { default as PersonResult, Props as PersonResultProps, } from './components/Results/PersonResult';
export { default as ContainerResult, Props as ContainerResultProps, } from './components/Results/ContainerResult';

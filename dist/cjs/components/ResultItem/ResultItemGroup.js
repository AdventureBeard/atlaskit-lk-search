...
var ResultItemGroup = /** @class */ (function (_super) {
    ...
    ResultItemGroup.prototype.render = function () {
        ...
        var wrappedTitle = (React.createElement(styled_1.ResultItemGroupHeader, { className: "ak-result-item-group-header" },
            React.createElement(styled_1.ResultItemGroupTitle, { className: "ak-result-item-group-title" }, title)));
        return (React.createElement(item_1.ItemGroup, { title: wrappedTitle, className: "ak-result-item-group" }, children));
    };

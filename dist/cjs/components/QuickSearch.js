...
var Search_1 = tslib_1.__importDefault(require("./Search/Search"));
var context_1 = require("./context");
var decorateWithAnalyticsData_1 = tslib_1.__importDefault(require("./decorateWithAnalyticsData"));
...
var QuickSearch = /** @class */ (function (_super) {
    ...
    function QuickSearch(props) {
            ...
            if (event.key === 'ArrowUp') {
                ...
                if (event.shiftKey || !_this.state.selectedResultId) {
                    if (firePrivateAnalyticsEvent) {
                        firePrivateAnalyticsEvent(constants_1.QS_ANALYTICS_EV_SUBMIT, {
                            newTab: false,
                    ...
                    if (typeof firePrivateAnalyticsEvent === 'function') {
                        ...
                        firePrivateAnalyticsEvent(constants_1.QS_ANALYTICS_EV_SUBMIT, tslib_1.__assign(tslib_1.__assign({}, result.getAnalyticsData()), { method: 'returnKey', newTab: false, resultCount: _this.flatResults.length }));
                    }
        ...
        _this.acceptAutocomplete = function (event, text) {
            var onSearchInput = _this.props.onSearchInput;
            var newValue = text + " ";
    ...
    QuickSearch.prototype.componentDidMount = function () {
        ...
        if (firePrivateAnalyticsEvent) {
            firePrivateAnalyticsEvent(constants_1.QS_ANALYTICS_EV_OPEN, {});
        }
    };
    QuickSearch.prototype.componentWillUnmount = function () {
        var firePrivateAnalyticsEvent = this.props.firePrivateAnalyticsEvent;
        if (firePrivateAnalyticsEvent) {
            firePrivateAnalyticsEvent(constants_1.QS_ANALYTICS_EV_CLOSE, {});
        }
    };
    QuickSearch.prototype.UNSAFE_componentWillReceiveProps = function (nextProps) {
        ...
        if (sendAnalytics !== nextProps.firePrivateAnalyticsEvent ||
            ...
            this.setState({
                context: tslib_1.__assign(tslib_1.__assign({}, this.state.context), { sendAnalytics: nextProps.firePrivateAnalyticsEvent, linkComponent: nextProps.linkComponent }),
            });
        }
        /**
        ...
        if (!this.hasSearchQueryEventFired &&
            ...
            var firePrivateAnalyticsEvent = this.props.firePrivateAnalyticsEvent;
            if (firePrivateAnalyticsEvent) {
                firePrivateAnalyticsEvent(constants_1.QS_ANALYTICS_EV_QUERY_ENTERED, {});
            }
        }
    };
    QuickSearch.prototype.fireKeyboardControlEvent = function (selectedResultId) {
        ...
        if (firePrivateAnalyticsEvent) {
            ...
            if (result) {
                firePrivateAnalyticsEvent(constants_1.QS_ANALYTICS_EV_KB_CTRLS_USED, tslib_1.__assign(tslib_1.__assign({}, result.getAnalyticsData()), { key: this.lastKeyPressed, resultCount: this.flatResults.length }));
            }
        }
        this.lastKeyPressed = '';
    };
    QuickSearch.prototype.render = function () {
        return (React.createElement(Search_1.default, { isLoading: this.props.isLoading, inputControls: this.props.inputControls, onBlur: this.handleSearchBlur, onInput: this.onInput, onKeyDown: this.handleSearchKeyDown, placeholder: this.props.placeholder, value: this.state.value, autocompleteText: this.props.autocompleteText, ref: this.setSearchInputRef },
            React.createElement(context_1.ResultContext.Provider, { value: this.state.context },
                React.createElement(context_1.SelectedResultIdContext.Provider, { value: this.state.selectedResultId }, this.props.children))));
    };
 ...
 */
exports.default = decorateWithAnalyticsData_1.default(
// @ts-ignore
analytics_1.withAnalytics(QuickSearch, {}, {}));

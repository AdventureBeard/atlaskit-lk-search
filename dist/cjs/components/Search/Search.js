...
var Search = /** @class */ (function (_super) {
    ...
    Search.prototype.render = function () {
        ...
        return (React.createElement(styled_1.SearchInner, { className: "ak-search-inner" },
            React.createElement(styled_1.SearchBox, { className: "ak-search-box" },
                React.createElement(styled_1.SearchFieldBaseOuter, { className: "ak-search-field-base-outer" },
                    React.createElement(styled_1.SearchFieldBaseInner, { className: "ak-search-field-base-inner" },
                        ...
                        React.createElement(styled_1.SearchInput, { autoFocus: true, innerRef: this.setInputRef, onBlur: onBlur, onInput: onInput, placeholder: placeholder, spellCheck: false, type: "text", value: value, onChange: function () { }, onKeyDown: this.onInputKeyDown, className: "ak-search-input" }),

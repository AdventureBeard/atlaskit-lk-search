...
export default class Search extends React.PureComponent<Props> {
  ...
  render() {
    ...
    return (
      <SearchInner className="ak-search-inner">
        <SearchBox className="ak-search-box">
          <SearchFieldBaseOuter className="ak-search-field-base-outer">
            <SearchFieldBaseInner className="ak-search-field-base-inner">
              {autocomplete && (
                <SearchInputTypeAhead
                  spellCheck={false}
                  type="text"
